...
// Query
$sql = "SELECT * FROM table_status WHERE status_pemohonan ='Diluluskan'";
...
<div class="wrapper">
  ...
  <h1>Senarai Permohonan Diluluskan</h1>
  ...
  <table class="table">
    ...
    <?php while($row = $result->fetch_assoc()) { ?>
      ...
      <tr>
        ...
        <td>
          <span style="background-color: #28a745; color: #ffffff; padding: 5px 10px; border-radius: 5px;">Diluluskan</span>
        </td>
        <td>
        <a href="delete_approve.php?id_tempahan_makanan=<?php echo $row['id_tempahan_makanan']; ?>&user_id=<?php echo $row['user_id']; ?>">
